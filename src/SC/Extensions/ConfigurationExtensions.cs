...
public static class ConfigurationExtensions
{
    ...
    public static TOption GetOrAddValueOption<TOption, TValue>(this IConfiguration configuration, string path, Func<TValue> constructor) where TOption : class, IConfigurationOption, IValueConfigurationOption<TValue>, new() => configuration.GetOption<TOption>(path) ?? configuration.AddValueOption<TOption, TValue>(path, constructor());
    ...
    /// <returns>The existing or newly created configuration option.</returns>
    public static TOption GetOrAddValueOption<TOption, TValue>(this IConfiguration configuration, string path, TValue value) where TOption : class, IConfigurationOption, IValueConfigurationOption<TValue>, new() => configuration.GetOption<TOption>(path) ?? configuration.AddValueOption<TOption, TValue>(path, value);
    ...
    public static TOption AddValueOption<TOption, TValue>(this IConfiguration configuration, string path, TValue value) where TOption : class, IConfigurationOption, IValueConfigurationOption<TValue>, new()
    {
