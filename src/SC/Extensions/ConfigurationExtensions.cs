...
public static class ConfigurationExtensions
{
    ...
    public static TOption GetOrAddValueOption<TOption, TValue>(this IConfiguration configuration, string path, Func<TValue> constructor) where TOption : ConfigurationOptionBase, IValueConfigurationOption<TValue>, new() => configuration.GetOption<TOption>(path) ?? configuration.AddValueOption<TOption, TValue>(path, constructor());
    ...
    /// <returns>The existing or newly created configuration option.</returns>
    public static TOption GetOrAddValueOption<TOption, TValue>(this IConfiguration configuration, string path, TValue value) where TOption : ConfigurationOptionBase, IValueConfigurationOption<TValue>, new() => configuration.GetOption<TOption>(path) ?? configuration.AddValueOption<TOption, TValue>(path, value);
    ...
    public static TOption AddValueOption<TOption, TValue>(this IConfiguration configuration, string path, TValue value) where TOption : ConfigurationOptionBase, IValueConfigurationOption<TValue>, new()
    {
    ...
    /// <param name="path">The path of the option.</param>
    /// <returns>The existing or newly created configuration option.</returns>
    public static TOption GetOrAddOption<TOption>(this IConfiguration configuration, string path) where TOption : ConfigurationOptionBase, new() => configuration.GetOption<TOption>(path) ?? configuration.AddOption<TOption>(path);
    ...
    public static bool TryGetOption<TOption>(this IConfiguration configuration, string path, out TOption option) where TOption : ConfigurationOptionBase, new() => (option = configuration.GetOption<TOption>(path)) is not null;
