...
public static class ConfigurationSettingsExtensions
{
    ...
    public static string CombinePaths(this IConfigurationSettings settings, string left, string right) => string.IsNullOrEmpty(left) ? right : string.IsNullOrEmpty(right) ? left : left + settings.Separator + right;
}